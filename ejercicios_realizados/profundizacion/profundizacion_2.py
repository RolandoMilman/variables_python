...
#print('Ingrese el número del D.N.I.:')
dni = int(input('Ingrese el número del D.N.I.:'))
...
print('Nombre, Apellido y DNI:', nombre.capitalize(), apellido.capitalize(), dni)
print('Nombre completo, edad y altura:', nombre.capitalize(), apellido.capitalize(), edad, 'años', altura, 'm')