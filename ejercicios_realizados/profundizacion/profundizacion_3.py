...
nombre_2 = str(input('Ingrese su segundo nombre:'))


apellido = str(input('Ingrese su apellido:'))

print('Nombres y Apellidos en minúsculas:', nombre_1.lower().strip(), nombre_2.lower().strip(), apellido.lower().strip())

print('Nombres y Apellidos en mayúsculas:', nombre_1.upper().strip(), nombre_2.upper().strip(), apellido.upper().strip())

print('Nombres y Apellidos con primera letra en mayúsculas:', nombre_1.strip().capitalize(), nombre_2.strip().capitalize(), apellido.strip().capitalize())