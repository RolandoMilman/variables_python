...
padre_1 = str(input('Ingrese el nombre y apellido del padre:'))
nombre_1, apellido_1 = padre_1.split()
padre_2 = str(input('Ingrese el nombre y apellido de la madre:'))
nombre_2, apellido_2 = padre_2.split()
nombre_hijo = str(input('Ingrese el nombre y apellido del hijo:'))
nombre_3, apellido_3 = nombre_hijo.split()

nombre_completo = nombre_3.strip().capitalize(), apellido_1.strip().capitalize(), apellido_2.strip().capitalize()

print('Nombres y Apellidos con primera letra en mayúsculas:', nombre_completo)